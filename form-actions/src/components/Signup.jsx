...
function signupAction(prevFormState, formData) {
    ...
    if (!isNotEmpty(password) || !hasMinLength(confirmPassword, 6)) {
        errors.push('Please enter a valid password which has a minimum length of 6 characters.');
    }
    ...
    if (!isNotEmpty(firstName) || !isNotEmpty(lastName)) {
        errors.push('Please provide a first name and a last name.');
    }
    ...
    if (!terms) {
        errors.push('Please provide an terms with a terms.');
    }

    if (acquisitionChannel.length === 0) {
        errors.push('Please provide an acquisition channel.');
    }
