...
export function Opinion({opinion: {id, title, body, userName, votes}}) {
    ...
    const [upVoteFormState, upVoteFormAction, upVoteFormPending] = useActionState(upVoteAction, null);
    const [downVoteFormState, downVoteFormAction, downVoteFormPending] = useActionState(downVoteAction, null);
